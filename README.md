...
* Created pages and PHP code for the sidebar and homepage of the website, what user would see first when they logged in. To see more look at Andy's MyContributons.md 
